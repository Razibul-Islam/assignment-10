            ...
            <div className="md:flex md:justify-between block">
                  ...
                  <>
                    <div className="flex flex-col-reverse md:flex-row-reverse md:items-center ">
                      <div className="flex md:flex-row-reverse items-center mt-5 md:mt-0">
                        <Link
                          class="group max-w-max relative mx-1 flex flex-col items-center justify-center rounded-full border border-gray-500 p-1 text-gray-500 hover:bg-gray-200 hover:text-gray-600"
                          href="#"
                        >
                          <img
              ...
              >
                ...
                >
                  ...
                  <span class="absolute inset-0 z-10 m-1 inline-flex h-6 w-6 items-center justify-center rounded-full bg-white text-gray-400 transition peer-checked:translate-x-6 peer-checked:text-green-600">
                    <svg
                      data-unchecked-icon
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-4 w-4"
